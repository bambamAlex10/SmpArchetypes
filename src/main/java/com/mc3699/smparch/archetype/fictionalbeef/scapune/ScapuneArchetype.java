...
public class ScapuneArchetype extends BaseArchetype {
@Override
    public Component getName() {
        return Component.literal("Scapune");
    }
    ...
    public Set<ResourceLocation> getGrantedAbilities() {
        return Set.of(
                SMPArch.path("decievers_fury"),
                SMPArch.path("decievers_grace"),
                SMPArch.path("decievers_will")
        );
    }
